...
class NewProdsListScreen extends Component {
    ...
    componentDidMount() {
        ...
        const faucetsRef = deptRef.child('Faucets').orderByChild('key').limitToLast(10);
        const kitchSinksRef = deptRef.child('Kitchen Sinks').orderByChild('key').limitToLast(10);
        const tilesRef = deptRef.child('Tiles').orderByChild('key').limitToLast(10);
        const toiletsRef = deptRef.child('Toilets').orderByChild('key').limitToLast(10);
        const bathVansRef = deptRef.child('Bath Vanities').orderByChild('key').limitToLast(10);
        const toolsRef = deptRef.child('Tools').orderByChild('key').limitToLast(10);
        const schlutersRef = deptRef.child('Schluter Systems').orderByChild('key').limitToLast(10);
        const countertopsRef = deptRef.child('Countertops').orderByChild('key').limitToLast(10);
        const vanTopsRef = deptRef.child('Vanity Tops').orderByChild('key').limitToLast(10);
        const stoneTilesRef = deptRef.child('Stone Tiles').orderByChild('key').limitToLast(10);
        const cleanerSealersRef = deptRef.child('Cleaners & Sealers').orderByChild('key').limitToLast(10);
        const groutMortarsRef = deptRef.child('Grout & Mortars').orderByChild('key').limitToLast(10);
        const accessoriesRef = deptRef.child('Accessories').orderByChild('key').limitToLast(10);
