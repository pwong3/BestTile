...
class SCDetailsScreen extends Component {
    ...
    render() {
        const { headerTextStyle, cardSectionStyle, bodyTextStyle, phoneNumberStyle } = styles;
                ...
                <CardSection style={cardSectionStyle}>
                    ...
                    <Text style={bodyTextStyle}>
                        ...
                        <Text
                            ...
                            onPress={() => Linking.openURL('https://www.google.com/maps/dir/?api=1&destination=Best+Tile+%26+Building+Supply+Santa+Clara+CA&travelmode=driving')}
                        >
                            Get Directions
