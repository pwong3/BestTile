...
class ProductsDeptScreen extends Component {
  ...
  render() {
    ...
    const depts = [
      ...
      {
        dept: 'Porcelain Panels',
        deptImage: require('/Users/pat/Documents/React Native Projects/BestTile/src/resources/porcelainPanel.jpg'),
      },
      {
        dept: 'Stone Tiles',
      ...
      {
        dept: 'Stone Steps',
        deptImage: require('/Users/pat/Documents/React Native Projects/BestTile/src/resources/steps.jpg'),
      },
      {
        dept: 'Bath Vanities',
      ...
      {
        dept: 'Shower & Tub Enclosures',
        deptImage: require('/Users/pat/Documents/React Native Projects/BestTile/src/resources/cw8800.jpg'),
      },
      {
        dept: 'Faucets',
