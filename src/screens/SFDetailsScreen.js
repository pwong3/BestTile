...
class SFDetailsScreen extends Component {
    ...
    render() {
        const { cardSecTextStyle, cardSectionStyle, bodyTextStyle, phoneNumberStyle } = styles;
                ...
                <CardSection style={cardSectionStyle}>
                    ...
                    <Text style={bodyTextStyle}>
                        ...
                        <Text
                            ...
                            onPress={() => Linking.openURL('https://www.google.com/maps/dir/?api=1&destination=Best+Tile+Inc+San+Francisco+CA&travelmode=driving')}
                        >
                            Get Directions
