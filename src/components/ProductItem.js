...
class ProductItem extends PureComponent {
    ...
    removeFavorite = async (item) => {
        try {
            ...
            ToastAndroid.show(item.productName + ' removed from favorites.', ToastAndroid.SHORT)
    ...
    setFavorite = async (item) => {
        try {
            ...
            ToastAndroid.show(item.productName + ' added to favorites.', ToastAndroid.SHORT)
            this.getFavoritesKeys();
        } catch (e) {
            // save error
        }
    ...
    render() {
        ...
        return (
            <ScrollView backgroundColor='white'>
                <CardSection style={cardSectionStyle}>
                    ...
                    >
                        <View style={{ flexDirection: 'column', flex: 1 }}>
                            {(itemPassed.productBrand === '' || itemPassed.productDepartment === 'Tiles') ?
                                <Text style={productBrandText}>
                                    {itemPassed.productName}
                                </Text>
                                :
                                <View>
                                    <Text style={productBrandText}>
                ...
                {itemPassed.productDescription === '' ?
                    null
                    :
                    (<View>
                        <CardSection style={cardSectionStyle}>
                            <Text style={cardSecTitleStyle}>
                                Product Details
                        </Text>
                            ...
                            {descSplit.map((desc) => {
                                if (desc.includes('//h//')) {
                                    ...
                                    return (
                                        <Text
                                            key={desc}
                                            style={productDetailsHeaderText}
                                        >
                                            {header[1]}
                                        </Text>)
                                }
